...
<template>
  <nav class="hidden lg:block lg:sticky lg:top-0 lg:h-screen lg:overflow-y-auto lg:scrollbar-thin text-[length:var(--text-md)] leading-[var(--text-md-lh)]" aria-label="Main navigation">
    <div class="p-[2rem_2.5rem_2.5rem_1.5rem]">
      ...
      <div>
        <div class="text-[0.8125rem] font-bold text-foreground mt-6 mb-2 pl-3">Overview</div>
      ...
      <div>
        <div class="text-[0.8125rem] font-bold text-foreground mt-6 mb-2 pl-3">Components</div>
        <ul class="flex flex-col gap-px">
          <li class="relative">
            <router-link
              to="/components/field"
